...
public interface Board extends Cloneable {
	/** Checks if this position represents a victory for one side or the other.
	 * 
	...
	/** Changes this position according to the Move specified.
	 *
	 * @exception IllegalMoveException if this move is not legal
	 */
	public void move(Move m) throws IllegalMoveException;
	
	/** Tests if a move is legal from this position for the color given
	 */
	...
	/** Add a piece to the board; useful for setting up a position in
	 * testing.
	 * 
	 * @exception IllegalArgumentException if either coordinate of the point
	 * is not in the range 1..11
	...
	/** Returns all the legal moves for Color from this Position.
	 * 
	...
	/** Makes a deep copy of this Position */
	public Board clone();
}
