 ...
 *
 */
public class TestForDefects {
   /** Test White wins */
   @Test
   public void testWhiteWinsBottomLeft() 
   {
   ...
   @Test
   public void testWhiteWinsTopLeft()
   {
      Board aPosition = RulesFactory.getDefault().makeBoard();
   ...
   @Test
   public void testWhiteWinsBottomRight()
   {
      Board aPosition = RulesFactory.getDefault().makeBoard();
   ...
   @Test
   public void testWhiteWinsTopRight()
   {
      Board aPosition = RulesFactory.getDefault().makeBoard();
   ...
   public void testAddPiece()
   {
      ...
      assertTrue(aPosition.getPieceAt(new Point(2,6)) == Piece.WhiteKing);
   }
